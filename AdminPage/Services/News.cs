    ...
    internal class News
    {
        ...
        internal static n_news SaveNews(n_news nm, List<string> picmore, string newReId)
        {
            ...
            using (var db = new AdminEntities())
            {
                ...
                nm.Decription = nm.Decription?.Replace("src=\"/Upload/", $"src=\"{adminSite}/Upload/");
                nm.Decription = nm.Decription?.Replace("href=\"/Upload/", $"href=\"{adminSite}/Upload/");
                ...
                if (!string.IsNullOrEmpty(nm.NewsId))
                {
                    ...
                    news.Decription = nm.Decription;
                    news.Active = nm.Active;
                    news.CreatedAt = nm.CreatedAt ?? news.CreatedAt;
        ...
        internal static void updateNewsUrlCode()
        {
            ...
            {
                n.UrlCode = CommonFunc.ConvertNonUnicodeURL(n.Name);
            });
            db.SaveChanges();
        }
    }
