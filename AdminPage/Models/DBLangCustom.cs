namespace AdminPage.Models
{
    ...
    public class DBLangCustom : AdminEntities
    {
        ...
        public virtual IQueryable<productoptionprice> ProductOptionPrice => base.productoptionprices.Where(c => (c.LangCode ?? defaultCode) == LangCode);
