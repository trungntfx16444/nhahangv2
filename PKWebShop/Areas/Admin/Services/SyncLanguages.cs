namespace PKWebShop.Areas.Admin.Services
{
    ...
    public class SyncLanguages
    {
        ...
        internal static void CloneProduct(WebShopEntities db, List<product> listPro, product prod, string langCode)
        {
        ...
        internal static void CloneCategory(WebShopEntities db, List<category> listCate, category cate, string langCode)
        {
            ...
            {
                var cateParent = listCate.FirstOrDefault(x => x.ReId == cate.ParentId && x.LangCode == langCode);
                cate_clone.ParentId = cateParent.ReId;
        ...
        internal static string PriceOption()
        {
            using (var db = new WebShopEntities())
            {
                try
                {
                    ...
                    var listPriceOpt = db.ProductOptionPrice.AsQueryable();
        ...
        internal static void ClonePriceOption(WebShopEntities db, List<ProductOptionPrice> listPrice, ProductOptionPrice price, string langCode)
        {
            ...
            db.ProductOptionPrice.Add(price_clone);
            db.SaveChanges();
        ...
        internal static void CloneProperty(WebShopEntities db, List<product_properties> listProp, product_properties prop, string langCode)
        {
