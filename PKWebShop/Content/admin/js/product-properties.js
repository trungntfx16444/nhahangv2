...
function GetProperty(el) {
    ...
    if (_action == "add") {
        ...
        if (propId == "") {
            ...
            $.ajax({
                method: "POST",
                url: "/admin/productman/GetProperty",
                data: {
                    propertyReId: propId,
...
function SaveProperty() {
    $.ajax({
        method: "POST",
        url: "/admin/productman/SaveProperty",
...
function SaveValue() {
    ...
    $.ajax({
        method: "POST",
        url: "/admin/productman/SaveValue",
...
function ActionDelete(typeDel, idDel) {
    $.ajax({
        method: "POST",
        url: "/admin/productman/DelProperty",
...
function LoadProductProperties() {
    ...
    if (parent_prop != "" && prop != "") {
        $.ajax({
            method: "POST",
            url: "/admin/productman/LoadProductProperties",
            data: {
