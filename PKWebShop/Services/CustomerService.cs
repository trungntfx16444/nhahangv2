namespace PKWebShop.Services
{
    ...
    public class CustomerService : ServicesBase
    {
        ...
        {
            return DB.customers.FirstOrDefault(m => m.Id == cusId && m.Active == true);
        }
        ...
        public customer Register(customer rcus)
        {
            try
            {
                ...
                if (_cus == null)
                {
                    ...
                    _cus.Active = true;
                    _cus.Role = UserContent.CustomerRole.Member.Text();
                ...
                _cus.Province = rcus.Province;
                _cus.District = rcus.District;
                _cus.Ward = rcus.Ward;
