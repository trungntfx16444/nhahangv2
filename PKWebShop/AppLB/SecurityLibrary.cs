namespace PKWebShop.AppLB
{
    ...
    public class SecurityLibrary
    {
        ...
        {
            Rfc2898DeriveBytes rfc2898db = new (password, 16, 10000);
        ...
        {
            Rfc2898DeriveBytes rfc2898db = new (password, salt, 10000);
        ...
        public static string Encrypt(string plain)
        {
            try
            {
                ...
                {
                    using (AesCryptoServiceProvider aes256 = new ())
                    {
                        aes256.KeySize = 256;
                        ...
                        using (CryptoStream cs = new (ms, aes256.CreateEncryptor(), CryptoStreamMode.Write))
                        {
