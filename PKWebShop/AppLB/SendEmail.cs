namespace PKWebShop.AppLB
{
    ...
    public class SendEmail
    {
        ...
        static int webmailport = int.Parse(ConfigurationManager.AppSettings["EmailPort"]);
        static bool ssl = bool.Parse(ConfigurationManager.AppSettings["EmailSsl"]);
        ...
        public static string Send(string to, string subject, string body, string bcc = "", string cc = "", string fileAttach = null)
        {
            try
            {
                ...
                NetworkCredential nc = new (webmail, webmailpass);
                ...
                if (string.IsNullOrWhiteSpace(fileAttach) == false)
                {
                    ...
                    foreach (var item in attachFileArr)
                    {
                        ...
                        {
                            Attachment attack = new (item, MediaTypeNames.Application.Octet);
